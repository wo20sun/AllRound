...
final class Utils {
  ...
  static int getAnimationResource(int gravity, boolean isInAnimation) {
    switch (gravity) {
      case Gravity.TOP:
        return isInAnimation ? R.anim.basedialog_slide_in_top : R.anim.basedialog_slide_out_top;
      case Gravity.BOTTOM:
        return isInAnimation ? R.anim.basedialog_slide_in_bottom : R.anim.basedialog_slide_out_bottom;
      case Gravity.CENTER:
        return isInAnimation ? R.anim.basedialog_fade_in_center : R.anim.basedialog_fade_out_center;
      default:
