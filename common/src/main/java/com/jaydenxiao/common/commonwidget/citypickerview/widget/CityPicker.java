package com.jaydenxiao.common.commonwidget.citypickerview.widget;
...
import com.jaydenxiao.common.commonwidget.citypickerview.model.CityModel;
import com.jaydenxiao.common.commonwidget.citypickerview.model.DistrictModel;
import com.jaydenxiao.common.commonwidget.citypickerview.model.ProvinceModel;
import com.jaydenxiao.common.commonwidget.citypickerview.widget.wheel.OnWheelChangedListener;
import com.jaydenxiao.common.commonwidget.citypickerview.widget.wheel.WheelView;
import com.jaydenxiao.common.commonwidget.citypickerview.widget.wheel.adapters.ArrayWheelAdapter;
...
public class CityPicker implements CanShow, OnWheelChangedListener {
    ...
    private String contentBackgroundColorStr = "#E9E9E9";
    ...
    private CityPicker(Builder builder) {
        ...
        this.contentBackgroundColorStr = builder.contentBackgroundColorStr;
        ...
        ll_title = (LinearLayout) popview.findViewById(R.id.ll_title);
        ...
        if (!TextUtils.isEmpty(this.contentBackgroundColorStr)) {
            ll_title.setBackgroundColor(Color.parseColor(this.contentBackgroundColorStr));
        }
    ...
    public static class Builder {
         ...
         * @return
         */
        public Builder contentBackgroundColor(String colorBg) {
            this.contentBackgroundColorStr = colorBg;
            return this;
        }
...
//            SAXParser parser = spf.newSAXParser();
            ...
            String s = handler.readAssertResource(context, "province.txt");

            org.json.JSONObject jsonObject = new org.json.JSONObject(s);
            String address = jsonObject.getString("address");

            provinceList = JSON.parseArray(address, ProvinceModel.class);
...
//            provinceList = handler.getDataList();
            ...
            if (provinceList != null && !provinceList.isEmpty()) {
                ...
                List<CityModel> cityList = provinceList.get(0).getSub();
                if (cityList != null && !cityList.isEmpty()) {
                    mCurrentCityName = cityList.get(0).getName();
                    List<String> districtList = cityList.get(0).getSub();
            ...
            for (int i = 0; i < provinceList.size(); i++) {
                ...
                List<CityModel> cityList = provinceList.get(i).getSub();
                String[] cityNames = new String[cityList.size()];
                for (int j = 0; j < cityList.size(); j++) {
                    // 遍历省下面的所有市的数据
                    cityNames[j] = cityList.get(j).getName();
                    List<String> districtList = cityList.get(j).getSub();
