...
package com.jaydenxiao.common.commonwidget.citypickerview.widget.wheel;
...
import com.jaydenxiao.common.commonwidget.citypickerview.widget.wheel.adapters.WheelViewAdapter;
...
public class WheelView extends View {
    ...
    private void drawShadows(Canvas canvas) {
        ...
        LogUtil.d("liji.wheel", "getItemHeight(): " + getItemHeight());
        LogUtil.d("liji.wheel", "height: " + height);
        LogUtil.d("liji.wheel", "getWidth: " + getWidth());
        LogUtil.d("liji.wheel", "getHeight():" + getHeight());
        LogUtil.d("liji.wheel", "visibleItems:" + visibleItems);
    }
